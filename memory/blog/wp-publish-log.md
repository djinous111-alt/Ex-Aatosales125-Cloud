...
## 2026-07-20 — AS11 tamozhennaya-poshlina-na-avto-2026-kak-rasschitat

- **verdict:** PASS
- **post_id:** 3535
- **permalink:** https://avtosales125.ru/2026/07/20/tamozhennaya-poshlina-na-avto-2026-kak-rasschitat/
- **featured_image:** 3536
- **inline_images:** 3537 (`inline-01.png`), 3538 (`inline-02.png`), 3539 (`inline-03.png`)
- **schema_meta:** ok (`_excalibur_blog_schema_jsonld`)
- **skip_theme_faq_meta:** ok
- **method:** SSH (paramiko) + HTTP trigger OK (no WebFetch fallback); `SSH_ROOT=.`
- **live HEAD:** 200
- **result:** `memory/blog/articles/AS11-tamozhennaya-poshlina-na-avto-2026-kak-rasschitat/wp-publish-result.json`
