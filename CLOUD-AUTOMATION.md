...
Fallback: если Task types недоступны — `Task(generalPurpose)` per role (включая geo-qa); это канон, см. AGENTS.md / pitfalls. Не открывай новый incident на каждый such fallback.
