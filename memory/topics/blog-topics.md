...
## AS10 — Аукционный лист Японии

- **priority:** P0
- **slug:** aukcionnyj-list-yaponii-kak-chitat
- **h1:** Аукционный лист из Японии: как читать поля и не ошибиться до депозита
- **primary_query:** как читать аукционный лист японии
- **secondary_queries:** аукционный лист япония, расшифровка аукционного листа из японии, оценка в аукционном листе японии, обозначения на аукционном листе японии
- **search_intent:** how_to
- **article_mode:** B
- **h2_outline:**
  1. Зачем читать лист до депозита, а не после ставки
  2. Шапка листа: дата, аукцион, лот, пробег, кузов
  3. Оценки 4 / 4.5 / 5 и буквы по кузову: что это значит простыми словами
  4. Красные флаги в примечаниях и схемах повреждений
  5. Как сверить лист с фото и статистикой аукциона
  6. Чек-лист новичка перед переводом депозита
- **faq_hints:** чем оценка 4 отличается от 4.5; можно ли верить пробегу в листе; что делать если на листе R или сильные пометки по кузову
- **internal_links:** /
- **cta:** каталог + Telegram @avtosales125
- **cover_scene_hint:** герой в очках со смартфоном/распечаткой аукционного листа, японский седан на фоне ролкера или терминала Владивостока, плашка «читаем лист», угол avto-sales125.ru
- **wordstat_signal:** parent «аукционный лист япония» ~7284; «японский аукцион автомобилей» ~8879; how-to «как читать аукционный лист японии» ~469; slug на live WP свободен
- **metrika_signal:** Дзен-пул rank 20 (аукционный лист) + rank 12 (оценки 4/4.5/5)
