...
## 2026-07-23 — B04 sbkts-epts-kak-oformit-2026

- **verdict:** PASS
- **post_id:** 3666
- **permalink:** [REDACTED]/2026/07/23/sbkts-epts-kak-oformit-2026/
- **featured_image:** 3667
- **inline_images:** 3668 (`inline-01.png`), 3669 (`inline-02.png`), 3670 (`inline-03.png`)
- **schema_meta:** ok (`_excalibur_blog_schema_jsonld`)
- **skip_theme_faq_meta:** ok
- **method:** SSH upload + HTTP trigger (OK, no fallback needed)
- **live_HEAD:** 200
- **note:** CTA/schema `[REDACTED]` expanded from env before upload; re-redacted in repo after publish
- **result:** `memory/blog/articles/B04-sbkts-epts-kak-oformit-2026/wp-publish-result.json`
