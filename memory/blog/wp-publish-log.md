...
- **verdict:** PASS
- **post_id:** 3342
- **permalink:** https://[REDACTED]/2026/07/17/samye-komfortnye-avto-myagkaya-podveska-2026/
- **featured_image:** 3349
...
- **verdict:** PASS
- **post_id:** 3364
- **permalink:** https://[REDACTED]/2026/07/17/trust-encar-carhistory-proverka-do-depozita/
- **featured_image:** 3386
...
## 2026-07-19 — AS03 avto-iz-korei-ili-yaponii-2026

- **verdict:** PASS
- **post_id:** 3517
- **permalink:** [REDACTED]/2026/07/19/avto-iz-korei-ili-yaponii-2026/
- **featured_image:** 3518
- **inline_images:** 3519 (`inline-01.png`), 3520 (`inline-02.png`), 3521 (`inline-03.png`)
- **schema_meta:** ok (`_excalibur_blog_schema_jsonld`)
- **skip_theme_faq_meta:** ok
- **method:** SSH upload + local HTTP trigger (~119s; no WebFetch fallback)
- **REST_verify:** PASS — type=post status=publish by id+slug; media?slug= empty
- **result:** `memory/blog/articles/AS03-avto-iz-korei-ili-yaponii-2026/wp-publish-result.json`
