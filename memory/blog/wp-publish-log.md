...
## 2026-07-20 — AS11 privezti-elektromobil-iz-kitaya-2026

- **verdict:** PASS
- **post_id:** 3547
- **permalink:** https://avtosales125.ru/2026/07/20/privezti-elektromobil-iz-kitaya-2026/
- **featured_image:** 3548
- **inline_images:** 3549 (`inline-01.png`), 3550 (`inline-02.png`), 3551 (`inline-03.png`)
- **schema_meta:** ok (`_excalibur_blog_schema_jsonld`)
- **skip_theme_faq_meta:** ok
- **method:** SSH upload + HTTP trigger (paramiko)
- **note:** first attempt ModuleNotFoundError paramiko — installed python3-paramiko via apt; SSH_ROOT unset (script OK); CTA already live (GEO QA reinject)
- **result:** `memory/blog/articles/AS11-privezti-elektromobil-iz-kitaya-2026/wp-publish-result.json`
