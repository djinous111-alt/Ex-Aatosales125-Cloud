...
7. Каждый H2: рекомендация с **точными** utility-маркерами из policy (`Не делайте`, `Шаг N`, `проверьте`, `избегайте`, `сделайте`…) — не только заголовок «Делать/Не делать». Lead: pain-маркеры; до FAQ: outcome-маркеры.
