...
## 2026-07-20 — AS10 sbkts-i-epts-vladivostok-2026

- **verdict:** PASS
- **post_id:** 3541
- **permalink:** [REDACTED]/2026/07/20/sbkts-i-epts-vladivostok-2026/
- **featured_image:** 3542
- **inline_images:** 3543 (`inline-01.png`), 3544 (`inline-02.png`), 3545 (`inline-03.png`)
- **schema_meta:** ok (`_excalibur_blog_schema_jsonld`)
- **skip_theme_faq_meta:** ok
- **method:** SSH upload + HTTP trigger (paramiko; SSH_ROOT unset → bootstrap in login cwd)
- **note:** reinject CTA/schema/llms from env before publish; installed paramiko via pip `--break-system-packages` (missing dep)
- **result:** `memory/blog/articles/AS10-sbkts-i-epts-vladivostok-2026/wp-publish-result.json`
