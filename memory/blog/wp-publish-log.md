...
## 2026-07-21 — AS18 postanovka-na-uchet-avto-iz-yaponii-2026

- **verdict:** PASS
- **post_id:** 3589
- **permalink:** /2026/07/21/postanovka-na-uchet-avto-iz-yaponii-2026/
- **featured_image:** 3596
- **inline_images:** 3597 (`inline-01.png`), 3598 (`inline-02.png`), 3599 (`inline-03.png`)
- **schema_meta:** ok (`_excalibur_blog_schema_jsonld`)
- **skip_theme_faq_meta:** ok
- **method:** SSH upload (`SSH_ROOT=.`) + HTTP trigger OK on retry (~120s; first attempt TimeoutError + WebFetch wait empty)
- **live_HEAD:** 200
- **result:** `memory/blog/articles/AS18-postanovka-na-uchet-avto-iz-yaponii-2026/wp-publish-result.json`
