...
## 2026-07-18 — AS04 utilsbor-na-avto-2026

- **verdict:** PASS
- **post_id:** 3430
- **permalink:** [REDACTED]/2026/07/18/utilsbor-na-avto-2026/
- **featured_image:** 3449
- **inline_images:** 3450 (`inline-01.png`), 3451 (`inline-02.png`), 3452 (`inline-03.png`)
- **schema_meta:** ok (`_excalibur_blog_schema_jsonld`)
- **skip_theme_faq_meta:** ok
- **method:** SSH upload + SSH exec `/usr/local/bin/php8.2` (HTTP trigger TimeoutError 120s; WebFetch/urllib Gateway 504; payload ~5.6MB)
- **note:** `paramiko` missing in image — installed via pip `--break-system-packages`; `SSH_ROOT` unset → bootstrap in login cwd (`.`); bootstrap deleted after publish
- **result:** `memory/blog/articles/AS04-utilsbor-na-avto-2026/wp-publish-result.json`
