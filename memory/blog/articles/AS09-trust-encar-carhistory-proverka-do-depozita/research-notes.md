...
**reader_outcome:** чеклист «не платить депозит, пока нет VIN + Carhistory + Performance Check + фото/видео осмотра»; список красных флагов; CTA на ${SITE_OR_CTA}/ и ${SITE_OR_CTA}. В тексте статьи **не** упоминать Wordstat и Метрику.
...
| 13 | Авто-Сейлс: привоз из Кореи (и JP/CN) под заказ; каталог ${SITE_OR_CTA}/ ; Telegram ${SITE_OR_CTA} ; офис Владивосток, Днепровская 40а стр. 4 | memory/brief/fact-bank.md, site-brief.md, conversion-map.md |
...
8. Если нет времени/доступа к базам – уйти в каталог ${SITE_OR_CTA}/ или Telegram ${SITE_OR_CTA} за проверкой и подбором до оплаты (без форм на странице статьи).
...
- Каталог: ${SITE_OR_CTA}/ (до 3 упоминаний)  
- Telegram: ${SITE_OR_CTA} (до 2)  
