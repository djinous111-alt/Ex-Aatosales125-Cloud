...
## 2026-07-18 — AS06 rastamozhka-avto-iz-yaponii-2026

- **verdict:** PASS
- **post_id:** 3460
- **permalink:** [REDACTED]/2026/07/18/rastamozhka-avto-iz-yaponii-2026/
- **featured_image:** 3461
- **inline_images:** 3462 (`inline-01.png`), 3463 (`inline-02.png`), 3464 (`inline-03.png`)
- **schema_meta:** ok (`_excalibur_blog_schema_jsonld`)
- **skip_theme_faq_meta:** ok
- **method:** SSH upload + HTTP trigger (no fallback needed; ~114s)
- **note:** paramiko installed via `pip3 install --break-system-packages paramiko` (missing in image); SSH_ROOT unset → bootstrap in SSH cwd
- **result:** `memory/blog/articles/AS06-rastamozhka-avto-iz-yaponii-2026/wp-publish-result.json`
