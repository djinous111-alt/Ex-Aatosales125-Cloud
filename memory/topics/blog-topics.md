...
## B01 — Растаможка авто из Кореи (этапы 2026)

- **priority:** P0
- **slug:** kak-rastamozhit-avto-iz-korei-2026
- **h1:** Как растаможить авто из Кореи через Владивосток в 2026: этапы и чек-лист
- **primary_query:** растаможка авто из кореи
- **secondary_queries:** растаможка авто из кореи в россию, растаможка авто из кореи владивосток, растаможка авто из кореи 2026, сколько стоит растаможка авто из кореи
- **search_intent:** how_to
- **article_mode:** B
- **h2_outline:**
  1. С чего начать новичку: путь Encar → море → Владивосток → учёт
  2. Какие документы собрать до оплаты и отправки
  3. Этапы на таможне: СВХ, декларация, пошлина и утильсбор без готовых сумм
  4. СБКТС, ЭПТС и что проверить перед отправкой в регион
  5. Типичные задержки и как их избежать
  6. Чек-лист перед депозитом и перед выпуском с таможни
- **faq_hints:** сколько roughly этапов растаможки из Кореи; чем Корея отличается от Японии по срокам; нужен ли брокер во Владивостоке; где считать пошлину и утильсбор без устаревших таблиц
- **internal_links:** /
- **cta:** каталог + Telegram @avtosales125
- **cover_scene_hint:** порт Владивостока, ролкер, современный корейский седан, герой Авто-Сейлс с плашкой «как растаможить», угол avto-sales125.ru
- **wordstat_signal:** parent «растаможка авто из кореи» ~3452 (регион 225); узкий «как растаможить авто из кореи» low-result ~23 – FAQ/хвост из широкого кластера
- **metrika_signal:** Japan-аналог лидер Дзена – пробел по Корее; на live WP нет отдельной растаможки Кореи (есть «под заказ»)
- **gap_note:** не дублирует live slug avto-iz-korei-pod-zakaz-2026; AS01 в пуле с тем же углом, но ID AS* невидим для today/scout_helper
