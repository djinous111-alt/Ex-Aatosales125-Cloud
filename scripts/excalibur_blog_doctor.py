...
def main() -> int:
    ...
    check("--url-mode" in llms_help.stdout, "llms generator supports --url-mode", errors, warnings)
    check("--blog-path" not in llms_help.stdout, "llms generator has no obsolete --blog-path", errors, warnings)
