...
## 2026-07-22 — AS10 hyundai-avante-iz-korei-kak-vybrat-2026

- **verdict:** PASS
- **post_id:** 3613
- **permalink:** [REDACTED]/2026/07/22/hyundai-avante-iz-korei-kak-vybrat-2026/  <!-- pragma: allowlist secret -->
- **featured_image:** 3614
- **inline_images:** 3615 (`inline-01.png`), 3616 (`inline-02.png`), 3617 (`inline-03.png`)
- **schema_meta:** ok (`_excalibur_blog_schema_jsonld`)
- **skip_theme_faq_meta:** ok
- **method:** SSH upload + HTTP trigger (paramiko installed at runtime; SSH_ROOT empty → default remote path)
- **note:** first attempt failed `ModuleNotFoundError: paramiko`; recovered via `pip3 install --break-system-packages paramiko`
- **result:** `memory/blog/articles/AS10-hyundai-avante-iz-korei-kak-vybrat-2026/wp-publish-result.json`
