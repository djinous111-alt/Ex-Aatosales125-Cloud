...
## 2026-07-18 — AS02 encar-na-russkom-kak-chitat

- **verdict:** PASS
- **post_id:** 3394
- **permalink:** [REDACTED]/2026/07/18/encar-na-russkom-kak-chitat/
- **featured_image:** 3395
- **inline_images:** 3396 (`inline-01.png`), 3397 (`inline-02.png`), 3398 (`inline-03.png`)
- **schema_meta:** ok (`_excalibur_blog_schema_jsonld`)
- **skip_theme_faq_meta:** ok
- **method:** SSH upload + HTTP trigger (no WebFetch fallback needed)
- **note:** restored CTA hrefs from CATALOG_URL/TELEGRAM_URL before publish; installed paramiko at runtime (missing from cloud install)
