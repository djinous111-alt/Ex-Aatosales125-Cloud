...
```
Signature на фото ≠ мотор до 160

• Prestige / Noblesse / Signature бывают на 2.0, LPG и турбо 180
...
- [x] Локальный interlinker: 0 opportunities (3 articles loaded; suggestions empty)

## Метрики (7 дней)

- [ ] Metrika / GA4 — goal `blog_read` или из conversion map
- [ ] Позиция primary query «киа к5 из кореи» (ручная проверка / Wordstat)
