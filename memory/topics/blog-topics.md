...
## B03 — Корея или Китай под один бюджет
...
- **secondary_queries:** авто из кореи и китая, авто под заказ из кореи и китая, авто из китая или кореи какие лучше, привезти авто из кореи или китая
- **search_intent:** comparison
- **article_mode:** B
- **h2_outline:**
  1. Зафиксировать бюджет "под ключ" до выбора страны (без магических цен)
  2. Корея: что даёт Encar-путь новичку и где типичные ловушки
  3. Китай: документы, комплектации и на что смотреть до оплаты
  4. Сравнение по рулю, срокам через Владивосток и риску сюрпризов
  5. Таблица выбора: семья / город / трасса / первый заказ
  6. Чек-лист из 10 пунктов перед депозитом
- **faq_hints:** что выгоднее под один бюджет Корея или Китай; можно ли сравнивать без точных цен пошлин; с чего начать новичку если ещё не выбрал модель
- **internal_links:** /
- **cta:** каталог + Telegram @avtosales125
- **cover_scene_hint:** герой Авто-Сейлс между корейским седаном и китайским кроссовером у порта Владивостока, плашка "Корея или Китай", угол avto-sales125.ru
- **wordstat_signal:** parent "авто из кореи" ~164654; "авто из кореи и китая" 3113; how-to "авто из кореи или китая" 315; narrow "что выгоднее..." low-result totalCount only
- **metrika_signal:** zen-topics rank 11 Korea/China same-budget gap; WP recent без comparison-slug Корея vs Китай
