...
2. `python3 scripts/excalibur_blog_llms_generator.py --blog-dir memory/blog/articles --site-base ${PUBLIC_SITE_URL} --out-dir memory/blog` (не передавай `--blog-path /` — это alias `--blog-dir`, не URL path)
