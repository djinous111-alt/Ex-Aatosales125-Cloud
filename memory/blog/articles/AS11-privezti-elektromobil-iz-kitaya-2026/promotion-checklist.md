...
```
Депозит за Zeekr без сметы — лотерея

• До оплаты: модель, батарея и 30-минутная мощность
...
- [x] Локальный interlinker: 0 opportunities (AS08/AS09 — другие кластеры; AS01–AS07/AS10 на live — вручную после publish)

## Метрики (7 дней)

- [ ] Metrika / GA4 — goal `blog_read` или из conversion map
- [ ] Позиция primary query «привезти электромобиль из китая» (ручная проверка / Wordstat)
