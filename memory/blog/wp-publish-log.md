...
## 2026-07-22 — AS19 rastamozhka-avto-iz-kitaya-2026

- **verdict:** PASS
- **post_id:** 3601
- **permalink:** [REDACTED]/2026/07/22/rastamozhka-avto-iz-kitaya-2026/
- **featured_image:** 3602
- **inline_images:** 3603 (`inline-01.png`), 3604 (`inline-02.png`), 3605 (`inline-03.png`)
- **schema_meta:** ok (`_excalibur_blog_schema_jsonld`)
- **skip_theme_faq_meta:** ok
- **method:** SSH upload + HTTP trigger (no fallback needed)
- **note:** first attempt failed `ModuleNotFoundError: paramiko`; installed `python3-paramiko` via apt; `SSH_ROOT` unset (upload OK without dot-fallback)
- **result:** `memory/blog/articles/AS19-rastamozhka-avto-iz-kitaya-2026/wp-publish-result.json`
