...
```
Красивый лот — а вывезти нельзя?

• Сначала японский экспортный фильтр (обычно ≤1,9 л)
...
- [x] Локальный interlinker: 0 opportunities (AS06 vs AS08/AS09 — нет пересечения якорей/queries в HTML)

## Метрики (7 дней)

- [ ] Metrika / GA4 — goal `blog_read` или из conversion map
- [ ] Позиция primary query «растаможка авто из японии» (ручная проверка / Wordstat)
