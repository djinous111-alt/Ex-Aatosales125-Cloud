...
## 2026-07-19 — AS07 dokumenty-na-avto-iz-kitaya

- **verdict:** PASS
- **post_id:** 3194
- **permalink:** [REDACTED]/dokumenty-na-avto-iz-kitaya/
- **featured_image:** 3466
- **inline_images:** 3467 (`inline-01.png`), 3468 (`inline-02.png`), 3469 (`inline-03.png`)
- **schema_meta:** ok (`_excalibur_blog_schema_jsonld`)
- **skip_theme_faq_meta:** ok
- **method:** SSH (paramiko) bootstrap + HTTP trigger OK (no WebFetch fallback)
- **note:** Cloud env имел `SSH_PATH` без `SSH_ROOT` — session map `SSH_PATH→SSH_ROOT`; configured root ENOENT → auto-fallback `.`; `paramiko` отсутствовал — `pip3 install --break-system-packages paramiko`
