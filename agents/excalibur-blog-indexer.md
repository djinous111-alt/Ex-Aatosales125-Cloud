...
2. `python3 scripts/excalibur_blog_llms_generator.py --blog-dir memory/blog/articles --site-base "" --out-dir memory/blog` (флаг `--blog-dir`, не `--blog-path`; для commit в repo — пустой/`""` site-base)
